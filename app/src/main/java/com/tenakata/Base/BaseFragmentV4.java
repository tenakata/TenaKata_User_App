...
public class BaseFragmentV4 extends Fragment implements BaseCallBacks {
    ...
    public void onTaskSuccess(ArrayList<?> list) {
        ...
        if(callBacks!=null)callBacks.onTaskSuccess(list);
    }

    @Override
    public void onTaskSuccess(boolean success) {

        if(callBacks!=null)callBacks.onTaskSuccess(success);
    }
    ...
    @Override
    public void onAppNeedForceUpdate(String messsage) {
        if(callBacks!=null)callBacks.onAppNeedForceUpdate(messsage);
    }
