...
public class SlidingRootNavBuilder {
    ...
    public SlidingRootNavBuilder withActionBarToggleView(View view){
        actionBarToggleView = view;
        return this;
    }

    public SlidingRootNavBuilder withToolbarRootView(View toolbar){
        toolbarView = toolbar;
        return this;
    }
    ...
    private SlidingRootNavLayout createAndInitNewRoot(View oldRoot) {
        ...
        newRoot.setToolbar(toolbarView);
        newRoot.setActionBarToggleView(actionBarToggleView);
    ...
    private void initToolbarMenuVisibilityToggle(final SlidingRootNavLayout sideNav, View drawer) {
        if (toolbar != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                toggle.getDrawerArrowDrawable().setColor(sideNav.getContext()
